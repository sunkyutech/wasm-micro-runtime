...
if ("$ENV{OPTEE_DIR}" STREQUAL "")
  set (OPTEE_DIR "/home/atmark/imx-boot-2020.04-at24")
else()
  set (OPTEE_DIR $ENV{OPTEE_DIR})
endif()

#include_directories (${OPTEE_DIR}/imx-optee-os_watz/out/arm/export-ta_arm64/include)
include_directories (${OPTEE_DIR}/imx-optee-os_watz/lib/libutee/include)
include_directories (${OPTEE_DIR}/imx-optee-os_watz/lib/libutils/ext/include)
